...
class BCCommon {
  ...
  public:
    ...
    const llvm::DenseMap<llvm::GlobalVariable *, GlobalVariableInfo> &getGlobalVariableMap() const {
    ...
    llvm::Function *findFunctionForConstantImpl(llvm::Constant *C, llvm::DenseSet<llvm::Constant *> &visited);
    llvm::Function *findFunctionFromUserImpl(llvm::User *U, llvm::DenseSet<llvm::User *> &visited);
